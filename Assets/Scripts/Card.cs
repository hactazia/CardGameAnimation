    ...
    IPointerExitHandler, IPointerUpHandler, IPointerDownHandler
{
    ...
    [Header("Selection")] public bool selected;
    ...
    [Header("States")] public bool isHovering;
    public bool isDragging;
    [HideInInspector] public bool wasDragged;
    public bool reCenterOnDragged = true;

    [Header("Events")] [HideInInspector] public UnityEvent<Card> PointerEnterEvent;
    ...
    void Start()
    {
        ...
        cardVisual = Instantiate(cardVisualPrefab, visualHandler ? visualHandler.transform : canvas.transform)
